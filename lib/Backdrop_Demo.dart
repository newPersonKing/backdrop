  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: Column(
        ...
        children: <Widget>[
          GestureDetector(
            behavior: HitTestBehavior.opaque, /*opaque 自己处理事件 deferToChild 子view处理事件  translucent 父view 子view都能响应事件*/
...
/*根据 controller 动态 切换顶部title的可见度*/
      ...
      child: Stack(
        children: <Widget>[
          Opacity(
            ...
            child:  Text('Select a Category'+animation.value.toString()),
          ),
          Opacity(
            opacity: CurvedAnimation(
              parent: animation,
...
class _BackdropDemoState extends State<BackdropDemo> with SingleTickerProviderStateMixin {
  final GlobalKey _backdropKey = GlobalKey(debugLabel: 'Backdrop'); /*debugLabel 只是用来debug 标识*/
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    ...
    print("details=="+details.primaryDelta.toString());
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constraints) {
    ...
    final Size panelSize = constraints.biggest; /*主体body的size*/
    final double panelTop = panelSize.height - panelTitleHeight;/*展示图片的区域高度*/
